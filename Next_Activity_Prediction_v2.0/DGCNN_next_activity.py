...
from GUI.GUI_option_train import SelectRangeAndSplitGui
min_prefissi_selezionato, max_prefissi_selezionato, percentuale_split, search_grid = SelectRangeAndSplitGui(selectParameters())
