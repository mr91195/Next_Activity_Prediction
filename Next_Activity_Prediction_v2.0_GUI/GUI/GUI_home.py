...
def ChooseActionGui():
    ...
    layout = [
        ...
        [sg.Radio("Preparazione dataset", "RADIO1", key="-PREP_DATASET-", font=("Helvetica", 12)), sg.Radio("Allenamento della rete", "RADIO1", key="-TRAIN_NET-", font=("Helvetica", 12))],
    ...
    while True:
        ...
        if event == sg.WINDOW_CLOSED or event == "Annulla":
            ...
            if values["-PREP_DATASET-"]:
                ...
                action = Azione.ALLENAMENTO_RETE
